...
> **Last Updated:** 2026-06-22 (Independent code audit + live multi-role browser testing; 17 additional defects found and fixed — see §12)  
...
| 22 | Screen 6.3 — Enquiries List | ✓ Done | Search, filter, status badges, pagination |
| 23 | Screen 6.4 — Log New Enquiry | ✓ Done | Quick form with all fields |
| 24 | Screen 6.5 — Enquiry Detail + Convert | ✓ Done | Converts to Company + Case Manager |
| 25 | Screen 6.6 — Companies List | ✓ Done | Search, filter by status/type |
| 26 | Screen 6.7 — Company Detail | ✓ Done | 5 sections: info, case managers, patients, comms, docs |
...
| `enquiries` | enquirer_name, company_name, email, phone, source, status, converted_to_company_id | →companies, →case_managers, →users |
...
| `app/Http/Controllers/EnquiryController.php` | index, create, store, show, update, convert |
| `app/Http/Controllers/CompanyController.php` | index, create, store, show, edit, update |
| `app/Http/Controllers/CaseManagerController.php` | show, createPortalLogin |
